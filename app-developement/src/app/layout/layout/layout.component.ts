...
import { AppletDetails } from 'src/app/types/custom.types';
...
export class LayoutComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.subscriptions[0] = this.connectionLostService.displayLostConnectionSubject.subscribe(display => {
      this.displayLostConnection = display;
    })
